...
`completion` is an OpenCLAW skill for task management across multiple roles. The skill teaches an agent how to maintain a SQLite-backed task list with role-weighted priorities, daily standups, and weekly reviews.
