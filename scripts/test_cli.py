...
def test_formatting():
    ...
    task = {
        "id": 42, "title": "Test task", "status": "in_progress",
    ...
    test("format_task_table uses DB ID not sequence", "#42:" in table)
    
    # Multi-role shows role tags
    task2 = dict(task, id=99, role_name="Personal", role_id=2, title="Personal task")
